...
$(() => {
    ...
    const UPDATE_SERVICE_VIEW_URL = APIS.invoiceDetailsEditView;
    const UPDATE_INVOICE_URL = APIS.updateInvoice;
    const UPDATE_PRICE_TABLE_URL = APIS.updateInvoicePricetable;
    const CREATE_PRICE_TABLE_URL = APIS.createInvoicePriceTable;
    const DELETE_PRICING_DATA_URL = APIS.deleteInvoicePricingRow;
    ...
    const UPDATE_PRICE_ROW = commonAjaxCalls.createInvoicePrice;
    const CREATE_PRICE_ROW = commonAjaxCalls.createInvoicePrice;
    const PRICE_AND_BILL_UPDATION_AT_ONCE = commonAjaxCalls.priceAndBillUpdationAtOnceForInvoice;
    const PRICE_CERATION_AND_BILL_UPADATION = commonAjaxCalls.priceCreationAndBillUpdationForInvoice;
    ...
    $.ajax({
        url: `${UPDATE_SERVICE_VIEW_URL}?AdminId=${ADMIN_AUTH}&InvoiceId=${TemplateId}`,
        type: "GET",
        async: false,
        dataType: "JSON",
        crossDomain: true,
        ...
        success: (data) => {
            ...
            $("#invoiceOn option:selected").text(data.InvoiceCode);
    ...
    $("#updateInvoiceSubmit").submit(function (e) {
        e.preventDefault();
        ...
        const submitButton = $("#updateInvoiceSubmit button[type='submit']");
        ...
        } else if (templateData.InvoiceCode == "") {
