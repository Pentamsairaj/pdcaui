                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function (index, values) {
                        ...
                        if (values.SRFNo == null) {
                            ...
                            var SRFNo = '<td> <div class=form-group><input type="text" name="" id="srfNo" value="' + values.SRFNo + '" class="srfNo form-control w-200px"></div></td> ';
                        }
                        if (datef == null) {
                            ...
                            var datef = '<td> <div class=form-group><input type="date" value="' + datef + '" name="" id="srfReceivedNum" class="srfReceivedNum form-control w-200px"></div></td> ';
                        }
                        if (values.Remarks == null) {
                            ...
                            var Remarks = '<td> <div class=form-group><textarea type="text" name="" id="srfRemarks" class="srfRemarks form-control w-200px">' + values.Remarks + '</textarea></div></td> ';
                        }
                        if (ADMIN_AUTH == "2d4ac65e-ff99-407a-a729-ccde60c7d5f1") {
                            ...
                            var getdetails = ' <tr> <td><input class="txtid" id="' + values.ID + '" type="hidden" value="' + values.ID + '"> <input type="button" name="&plus" value="+" class="addrow border-0 add btn btn-icon btn-light btn-sm" sno=' + snos++ + '></td><td>' + sno++ + '</td>' + SRFDraftFormat + ' ' + SRFForm + ' ' + FilledSRFUpload + ' ' + SRFNo + ' ' + datef + ' ' + Remarks + ' </tr>';
                            $("#table-iddoc11 tbody").append(getdetails);
                        }
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function (index, values) {
                        ...
                        if (values.SRFNo == null) {
                            ...
                            var SRFNo = '<td> <div class=form-group><input type="text" name="" id="srfnum" value="' + values.SRFNo + '" class="srfnum form-control w-200px"></div></td> ';
                        }
                        if (values.Reviewedby == null) {
                            ...
                            var Reviewedby = '<td> <div class=form-group><input type="text" name="" id="reviewedBy" value="' + values.Reviewedby + '" class="reviewedBy form-control w-200px"></div></td> ';
                        }
                        if (datef == null) {
                            var datef = '<td><div class=form-group><input type="date" name="" id="reviewedOn" class="reviewedOn form-control"></div></td>'
                        }
                        else {
                            var datef = '<td> <div class=form-group><input type="date" name="" id="reviewedOn" value="' + datef + '" class="reviewedOn form-control"></div></td> ';
                        }
                        if (values.Approval == null) {
                            ...
                            var Approval = '<td> <div class=form-group><input type="text" name="" id="approval" value="' + values.Approval + '" class="approval form-control w-200px"></div></td> ';
                        }
                        if (values.Remarks == null) {
                            ...
                            var Remarks = '<td> <div class=form-group><textarea type="text" name="" id="srfRemarks1" class="srfRemarks1 form-control w-200px">' + values.Remarks + '</textarea></div></td> ';
                        }
                        if (ADMIN_AUTH == "2d4ac65e-ff99-407a-a729-ccde60c7d5f1") {
                            ...
                            var getdetails = '<tr> <td> <input class="txtid" id="' + values.ID + '" type="hidden" value="' + values.ID + '"><input type="button" name="&plus" value="+" class="addrow border-0 add btn btn-icon btn-light btn-sm"/> </td><td>' + sno++ + '</td>' + SRFNo + ' ' + Reviewedby + ' ' + datef + ' ' + Approval + ' ' + Remarks + '</tr>';
                            $("#table-iddoc22 tbody").append(getdetails);
                        }
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function (index, values) {
                        ...
                        if (datef == null) {
                            ...
                            var datef = '<td> <div class=form-group><input type="date" value="' + datef + '" name="" id="regdate" class="regdate form-control"></div></td> ';
                        }
                        if (values.RegistrationNo == null) {
                            ...
                            var RegistrationNo = '<td> <div class=form-group><input type="text" name="" value="' + values.RegistrationNo + '" id="regNum" class="regNum form-control w-200px"></div></td> ';
                        }
                        if (values.SRFNo == null) {
                            var SRFNo = '<td> <div class="form-group"> <input type="text" name="" id="regsrfnum" class="regsrfnum form-control w-200px"> </div></td>'
                        }
                        else {
                            var SRFNo = '<td>  <div class="form-group"> <input type="text" name="" id="regsrfnum"  value="' + values.SRFNo + '" class="regsrfnum form-control w-200px"> </div></td> ';
                        }
                        if (values.TestParametersIn == null) {
                            ...
                            var TestParametersIn = '<td> <div class=form-group><textarea type="text" name="" id="testInhouse" class="testInhouse form-control w-200px">' + values.TestParametersIn + '</textarea></div></td> ';
                        }
                        if (values.TestParametersOut == null) {
                            ...
                            var TestParametersOut = '<td> <div class=form-group> <textarea type="text" name="" id="testOuthouse" class="testOuthouse form-control w-200px">' + values.TestParametersOut + '</textarea></div></td> ';
                        }
                        ...
                        if (values.OutsourcedTo == null) {
                            ...
                            var OutsourcedTo = '<td> <div class=form-group><input type="text" name="" id="Outsourcedto" value="' + values.OutsourcedTo + '" class="Outsourcedto form-control w-200px"></div></td> ';
                        }
                        if (dateg == null) {
                            var dateg = '<td><div class=form-group><input type="date" name="" id="Outsourcedon" class="Outsourcedon form-control"></div></td>'
                        }
                        else {
                            var dateg = '<td> <div class=form-group><input type="date" name="" id="Outsourcedon" value="' + dateg + '" class="Outsourcedon form-control"></div></td> ';
                        }
                        if (ADMIN_AUTH == "2d4ac65e-ff99-407a-a729-ccde60c7d5f1") {
                            var getdetails = ' <tr> <input class="txtid" id="' + values.ID + '" type="hidden" value="' + values.ID + '"> ' + datef + '' + RegistrationNo + '' + SRFNo + ' ' + TestParametersIn + ' ' + TestParametersOut + ' ' + Outsourcedreport + '' + OutsourcedTo + ' ' + dateg + '<td> <div class="deleteRow" style="cursor:pointer" id="' + values.ID + '"><i class="menu-icon flaticon2-rubbish-bin  text-danger"></i></div></td></tr>';
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function (index, values) {
                        ...
                        if (datef == null) {
                            ...
                            var datef = '<td> <div class=form-group><input type="date" value="' + datef + '" name="" id="regdate" class="regdate1 form-control"></div></td> ';
                        }
                        if (values.RegistrationNo == null) {
                        ...
                        if (values.Verifiedby == null) {
                            ...
                            var Verifiedby = '<td> <div class=form-group><input type="text" name="" id="verifiedBy" value="' + values.Verifiedby + '" class="verifiedBy form-control w-200px"></div></td> ';
                        }
                        if (dateg == null) {
                            var dateg = '<td><div class=form-group><input type="date" name="" id="verifiedOn" class="verifiedOn form-control"></div></td>'
                        }
                        else {
                            var dateg = '<td> <div class=form-group><input type="date" name="" id="verifiedOn" value="' + dateg + '" class="verifiedOn form-control"></div></td> ';
                        }
                        if (values.Remarks == null) {
                            ...
                            var Remarks = '<td> <div class=form-group><textarea type="text" name="" id="regRemarks" class="regRemarks form-control w-200px">' + values.Remarks + '</textarea></div></td> ';
                        }
                        if (ADMIN_AUTH == "2d4ac65e-ff99-407a-a729-ccde60c7d5f1") {
                            ...
                            var getdetails = '<tr> <td><input class="txtid" id="' + values.ID + '" type="hidden" value="' + values.ID + '"> <input type="button" name="&plus" value="+" class="addrow border-0 add btn btn-icon btn-light btn-sm" sno=' + snos++ + '></td><td>' + sno++ + '</td>' + datef + ' ' + RegistrationNo + ' ' + RawdataUpload + ' ' + Verifiedby + ' ' + dateg + ' ' + Remarks + '</tr>';
                            $("#table-iddoc44 tbody").append(getdetails);
                        }
