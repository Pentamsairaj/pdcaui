...
$(() => {
    ...
    function getDocId() {
        ...
        $.ajax({
            url: "https://api.pioneerfoods.in/ClientNewQualityManagement/DocID?ClientID=" + CLIENT_AUTH + "&jobID=" + jobID + "&type=" + 0,
            type: "get",
            contenttype: false,
            async: false,
            processdata: false,
    ...
    function getDocIdlevel4() {
        ...
        var jobID = $("#ddjobid").val();
        $.ajax({
            url: "https://api.pioneerfoods.in/ClientNewQualityManagement/DocID?ClientID=" + CLIENT_AUTH + "&jobID=" + jobID + "&type=" + 4,
            type: "get",
            contenttype: false,
            async: false,
            processdata: false,
    ...
    $("#table-quality tbody").on("click", ".deleterow", function () {
        ...
        if ($(this).closest("tr").attr("data-row-id")) {
            ...
            $.ajax({
                url: "https://api.pioneerfoods.in/ClientNewQualityManagement/DeleteQualityDoc?ClientID=" + CLIENT_AUTH + "&ID=" + id,
                type: "POST",
    ...
    //    $.ajax({
    //        url: "https://api.pioneerfoods.in/ClientNewQualityManagement/ConvertToPdf",
    //        type: "POST",
    //        data: formData,
    //        contentType: false,
    //        processData: false,
    ...
    function getQualityControldata(getvalue) {
        ...
        $.ajax({
            url: "https://api.pioneerfoods.in/ClientNewQualityManagement/getQualityDocsList?ClientID=" + CLIENT_AUTH + "&jobID=" + jobID + "&DocId=" + getvalue,
            type: "get",
            contenttype: false,
            processdata: false,
    ...
    $("#table-quality1 tbody").on("click", ".deleterow1", function () {
        ...
        if ($(this).closest("tr").attr("data-row-id")) {
            ...
            var id = $(this).closest("tr").attr("data-row-id")
            $.ajax({
                url: "https://api.pioneerfoods.in/ClientNewQualityManagement/DeleteTrainingDoc?ClientID=" + CLIENT_AUTH + "&trainingDocID=" + id,
                type: "POST",
                contentType: false, // Not to set any content header
                processData: false, // Not to process data
                /*data: fileData,*/
    ...
    $("#table-quality1-main tbody").on("click", ".deleterow1-main", function () {
        if ($(this).closest("tr").attr("data-row-id")) {
            ...
            var id = $(this).closest("tr").attr("data-row-id")
            $.ajax({
                url: "https://api.pioneerfoods.in/ClientNewQualityManagement/DeleteSkillDoc?ClientID=" + CLIENT_AUTH + "&skillDocID=" + id,
                type: "POST",
                contentType: false, // Not to set any content header
                processData: false, // Not to process data
                /*data: fileData,*/
        ...
        if (gettablelength > 0) {
            ...
            for (var i = 0; i < gettablelength; i++) {
                ...
                if (fileinputElement1 && fileinputElement1.files && fileinputElement1.files.length > 0) {
                    ...
                    //console.warn("File input disabled not found or no files selected.");
                }
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/ClientNewQualityManagement/CreateOrUpdateQualityDoc",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    function training() {
        ...
        if (gettablelength > 0) {
            ...
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/ClientNewQualityManagement/CreateOrUpdateTrainingDoc",
                    type: "POST",
                    data: postdata,
                    async: true,
                    dataType: "json",
    ...
    function skillmatrix() {
        ...
        if (gettablelength > 0) {
            ...
            for (var i = 0; i < gettablelength; i++) {
                ...
                postdata.append('ClauseNo', ClauseNo);
                $.ajax({
                    url: "https://api.pioneerfoods.in/ClientNewQualityManagement/CreateOrUpdateSkillDoc",
                    type: "POST",
                    data: postdata,
                    async: true,
                    dataType: "json",
    ...
    function getQualityControl2(value) {
        ...
        if (value) {
            ...
            var getrowcontent = '<tr><td>' + getIndex + '</td><td><div class="form-group"><textarea disabled type="text" name="" id="NameoftheDoc" class="NameoftheDoc form-control nameofdocument_styles" value="" edit_id="' + value.ID + '" tem_id="' + value.TemplateID + '" placeholder="Name of Document"> ' + value.Nameofthedoc + '</textarea></div></td><td><div class="form-group"><input disabled class="form-control type level_styles" id="type" name="" value="' + value.DocId + '" style="" placeholder="Type 4 Doc ID"></div></td><td><div class="form-group"><input disabled class="form-control ClauseNo level_styles" id="ClauseNo" value="' + value.clause + '" name="" style="" placeholder="Clause No."></div></td><td><div>' + Approveduplpdf + '</div></td><td><input disabled class="Draftformatfile w-300px form-control mb-2" id="certificateformatfile" aria-describedby="input disabledGroupFileAddon01" type="file" value_id=' + value.ID + ' accept="application/*" multiple><div>' + multidocViewButtons + '</div></td></tr>';
        ...
        //        });
        //    }
        //    var getrowcontent = '<tr><td>' + getIndex + '</td><td><div class="form-group"><textarea disabled type="text" name="" id="NameoftheDoc" class="NameoftheDoc form-control nameofdocument_styles" value="" edit_id="' + value.ID + '" placeholder="Name of Document"> ' + value.NameoftheDoc + '</textarea></div></td><td><div class="form-group"><input disabled class="form-control type level_styles" id="type" name="" value=' + value.DocId + ' style="" placeholder="Type 4 Doc ID"></div></td><td><div class="form-group"><input disabled class="form-control ClauseNo level_styles" id="ClauseNo" value=' + value.clause + ' name="" style="" placeholder="Clause No."></div></td><td><div><a href = ' + value.UploadMultiDocView + ' target = "_blank" class="btn btn-primary" > View</a ></div></td><td><input disabled class="Draftformatfile w-300px form-control mb-2" id="certificateformatfile" aria-describedby="input disabledGroupFileAddon01" type="file" value_id=' + value.ID + ' accept="application/*" multiple><div>' + multidocViewButtons + '</div></td><td><div class="deleterow2 my-2" style="cursor:pointer" id="delete"><i class="menu-icon flaticon2-rubbish-bin text-danger"></i></div></td></tr>';
        //    $("#table-quality2 tbody").append(getrowcontent);
        //});
        ...
        //var getrowcontent = '<tr><td>' + getIndex + '</td><td><div class="form-group"><textarea disabled type="text" id="NameoftheDoc" class="NameoftheDoc form-control nameofdocument_styles" placeholder="Name of Document"></textarea></div></td><td><div class="form-group"><input disabled class="form-control type level_styles" id="type" placeholder="Type 4 Doc ID"></div></td><td><div class="form-group"><input disabled class="form-control ClauseNo level_styles" id="ClauseNo" placeholder="Clause No."></div></td><td><div><a href ="#" target = "_blank" class="btn btn-primary" >View</a></div></td><td><input disabled class="Draftformatfile w-300px form-control mb-2" id="certificateformatfile" aria-describedby="input disabledGroupFileAddon01" type="file" accept="application/*" multiple></td><td><div class="deleterow2 my-2" style="cursor:pointer" id="delete"><i class="menu-icon flaticon2-rubbish-bin text-danger"></i></div></td></tr>';
        //$("#table-quality2 tbody").append(getrowcontent);
        //var getrowcontent = '<tr><td>' + getIndex + '</td><td><div class="form-group"><textarea disabled type="text" name="" id="NameoftheDoc" class="NameoftheDoc form-control nameofdocument_styles" value="" edit_id="' + value.ID + '" placeholder="Name of Document"> ' + value.NameoftheDoc + '</textarea></div></td><td><div class="form-group"><input disabled class="form-control type level_styles" id="type" name="" value=' + value.DocId + ' style="" placeholder="Type 4 Doc ID"></div></td><td><div class="form-group"><input disabled class="form-control ClauseNo level_styles" id="ClauseNo" value=' + value.clause + ' name="" style="" placeholder="Clause No."></div></td><td><div><a href = ' + value.UploadMultiDocView + ' target = "_blank" class="btn btn-primary" > View</a ></div></td><td><input disabled class="Draftformatfile w-300px form-control mb-2" id="certificateformatfile" aria-describedby="input disabledGroupFileAddon01" type="file" value_id=' + value.ID + ' accept="application/*" multiple></td><td><div class="deleterow2 my-2" style="cursor:pointer" id="delete"><i class="menu-icon flaticon2-rubbish-bin text-danger"></i></div></td></tr>';
        //$("#table-quality2 tbody").append(getrowcontent);
    }
    ...
    function getQualityControl2_Data() {
        ...
        if (getQualityControl_data_all.length > 0) {
            if (getQualityControl_data_all[0].ExecutionDocs.length != null && getQualityControl_data_all[0].ExecutionDocs.length != 0) {
                ...
                const currentRowCount = tableBody1.children("tr").length;
                const getIndex = currentRowCount + 1;
                var getrowcontent = '<tr><td>' + getIndex + '</td><td><div class="form-group"><textarea disabled type="text" id="NameoftheDoc" class="NameoftheDoc form-control nameofdocument_styles" placeholder="Name of Document"></textarea></div></td><td><div class="form-group"><input disabled class="form-control type level_styles" id="type" placeholder="Type 4 Doc ID"></div></td><td><div class="form-group"><input disabled class="form-control ClauseNo level_styles" id="ClauseNo" placeholder="Clause No."></div></td><td><div><a href="#" class="btn btn-primary viewButton disabled" >View</a></div></td><td><input disabled class="Draftformatfile w-300px form-control mb-2" id="certificateformatfile" aria-describedby="input disabledGroupFileAddon01" type="file" accept="application/*" multiple></td></tr>';
                $("#table-quality2 tbody").append(getrowcontent);
            }
        } else {
            var getrowcontent = '<tr><td>' + getIndex + '</td><td><div class="form-group"><textarea disabled type="text" id="NameoftheDoc" class="NameoftheDoc form-control nameofdocument_styles" placeholder="Name of Document"></textarea></div></td><td><div class="form-group"><input disabled class="form-control type level_styles" id="type" placeholder="Type 4 Doc ID"></div></td><td><div class="form-group"><input disabled class="form-control ClauseNo level_styles" id="ClauseNo" placeholder="Clause No."></div></td><td><div><a href="#" class="btn btn-primary viewButton disabled" >View</a></div></td><td><input disabled class="Draftformatfile w-300px form-control mb-2" id="certificateformatfile" aria-describedby="input disabledGroupFileAddon01" type="file" accept="application/*" multiple></td></tr>';
    ...
    function getQualityControl4_Data() {
        ...
        if (getQualityControl_data_all.length > 0)
            if (getQualityControl_data_all[0].ExternalAudits.length > 0) {
                ...
                const currentRowCount = tableBody1.children("tr").length;
                const getIndex = currentRowCount + 1;
                var getrowcontent = '<tr><td>' + getIndex + '</td><td><div class="form-group"><textarea disabled type="text" name="" id="NameoftheDoc2" class="NameoftheDoc form-control nameofdocument_styles" placeholder="Name of Document"></textarea></div></td><td><div class="form-group"><select disabled id="ddclause4" class="form-control" required><option value="">Select DOC ID</option></select></div></td><td><div class="form-group"><input disabled class="form-control ClauseNo level_styles" id="ClauseNo2" placeholder="Clause No."></div></td><td class="view5tabdoc"><div><a href="#" class="btn btn-primary viewButton disabled" >View</a></div></td><td><input disabled class="form-control Draftformatfile w-300px mb-2" id="certificateformatfile2" aria-describedby="input disabledGroupFileAddon01" type="file" accept="application/*" multiple></td></tr>';
    ...
    function getQualityControl3(value) {
        ...
        //var getrowcontent = '<tr><td>' + getIndex + '</td><td><div class="form-group"><textarea disabled type="text" name="" id="NameoftheDoc1" class="NameoftheDoc form-control nameofdocument_styles" placeholder="Name of Document"></textarea></div></td><td><div class="form-group"><input disabled class="form-control type level_styles" id="type1" placeholder="Type 4 Doc ID"></div></td><td><div class="form-group"><input disabled class="form-control ClauseNo level_styles" id="ClauseNo1" style="" placeholder="Clause No."></div></td><td><div><a href ="#" target = "_blank" class="btn btn-primary btn-sm" >View</a></div></td><td><input disabled class="form-control Draftformatfile w-300px mb-2" id="certificateformatfile1" aria-describedby="input disabledGroupFileAddon01" type="file" accept="application/*" multiple></td><td><div class="deleterow2 my-2" style="cursor:pointer" id="delete"><i class="menu-icon flaticon2-rubbish-bin text-danger"></i></div></td></tr>';
        //$("#table-quality3 tbody").append(getrowcontent);
    ...
    function getQualityControl4(value) {
        ...
        if (value) {
            ...
            var getrowcontent = '<tr><td>' + getIndex + '</td><td><div class="form-group"><textarea disabled type="text" name="" id="NameoftheDoc2" class="NameoftheDoc form-control nameofdocument_styles" value="" edit_id="' + value.ID + '" tem_id="' + value.templateid + '" placeholder="Name of Document"> ' + value.NameOfDocument + '</textarea></div></td><td><div class="form-group"><select disabled id="ddclause4" class="form-control ddclause4_' + value.ID + '" required></select ></div ></td ><td><div class="form-group"><input disabled class="form-control ClauseNo level_styles" id="ClauseNo2" value="' + value.ClauseNo + '" name="" style="" placeholder="Clause No."></div></td><td class="view5tabdoc"><div>' + ApprovedView + '</div></td><td><input disabled class="form-control Draftformatfile w-300px mb-2" id="certificateformatfile2" aria-describedby="input disabledGroupFileAddon01" type="file" value_id=' + value.ID + ' accept="application/*" multiple><div>' + multidocViewButtons + '</div></td></tr > ';
            $("#table-quality4 tbody").append(getrowcontent);
            getDocIdlevel4()
            $("#ddclause4").select2({
                //placeholder: "Search here...",
    ...
    $("#table-quality5 tbody").on("click", ".deleterow5", function () {
        if ($(this).closest("tr").attr("data-row-id")) {
            ...
            var id = $(this).closest("tr").attr("data-row-id")
            $.ajax({
                url: "https://api.pioneerfoods.in/ClientNewQualityManagement/DeleteQualityCertificate?ClientID=" + CLIENT_AUTH + "&docID=" + id,
                type: "POST",
                contentType: false, // Not to set any content header
                processData: false, // Not to process data
                /*data: fileData,*/
    ...
    $("#createTemplateSubmit2").submit((event) => {
        ...
        if (gettablelength > 0) {
            ...
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/ClientNewQualityManagement/CreateOrUpdateQualityTemplateExecution",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    $("#createTemplateSubmit3").submit((event) => {
        ...
        if (gettablelength > 0) {
            ...
            for (var i = 0; i < gettablelength; i++) {
                ...
                postdata.append('ClauseNo', ClauseNo);
                $.ajax({
                    url: "https://api.pioneerfoods.in/ClientNewQualityManagement/CreateOrUpdateInternalAuditMRM",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    $("#createTemplateSubmit4").submit((event) => {
        ...
        if (gettablelength > 0) {
            ...
            for (var i = 0; i < gettablelength; i++) {
                ...
                postdata.append('clause', ClauseNo);
                $.ajax({
                    url: "https://api.pioneerfoods.in/ClientNewQualityManagement/CreateOrUpdateExternalAuditMRM",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    $("#createTemplateSubmit5").submit((event) => {
        ...
        if (gettablelength > 0) {
            ...
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/ClientNewQualityManagement/CreateOrUpdateQualityCertificate",
                    type: "POST",
                    data: postdata,
                    async: true,
                    dataType: "json",
    ...
    function getQualitySystemExecutionData() {
        ...
        var jobID = $("#ddjobid").val();
        $.ajax({
            url: "https://api.pioneerfoods.in/ClientNewQualityManagement/ListAllQualityData?jobId=" + jobID,
            type: "GET",
            async: false,
            contentType: false,
            processData: false,
    ...
    function getlist() {
        $.ajax({
            url: "https://api.pioneerfoods.in/Quality_Template/List_Template?ClientID=" + CLIENT_AUTH,
            type: "GET",
            contentType: false,
            processData: false,
            success: function (data) {
    ...
    //    debugger;
    //    $.ajax({
    //        url: "https://api.pioneerfoods.in/Client/GetList?ClientID=" + CLIENT_AUTH,
    //        type: "GET",
    //        contentType: false,
    //        processData: false,
    ...
    //    $.ajax({
    //        url: EMPLOYEEE_DATA + CLIENT_AUTH,
    //        type: "GET",
    //        async: true,
    //        contentType: false,
    //        processData: false,
