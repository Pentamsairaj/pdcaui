$(document).ready(function () {
    ...
    function getJObID() {
        ...
        $.ajax({
            url: "https://api.pioneerfoods.in/Quality_Template/ListforJobID?AdminID=" + ADMIN_AUTH,
            type: "GET",
            async: false,
            contentType: false, // Not to set any content header
            processData: false, // Not to process data
        ...
        setTimeout(
            function () {
                ...
                if (checkexisting) {
                    ...
                    $.ajax({
                        url: "https://api.pioneerfoods.in/Quality_Template/Create_QualityTemplate",
                        type: "POST",
                        data: postdata,
                        dataType: "json",
                        traditional: true,
    ...
    function standardajax(template_ID) {
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_QualityStandard",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    function qualitydocs(template_ID) {
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_QualityTemplate_Document",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    //            postdata.append('authorid', ADMIN_AUTH);
    //            $.ajax({
    //                url: "https://api.pioneerfoods.in/Quality_Template/Create_QualityTemplate_Annual",
    //                type: "POST",
    //                data: postdata,
    //                async: false,
    //                dataType: "json",
    ...
    //            $.ajax({
    //                url: "https://api.pioneerfoods.in/Quality_Template/Create_QualityTemplate_Monthly",
    //                type: "POST",
    //                data: postdata,
    //                async: false,
    //                dataType: "json",
    ...
    //            $.ajax({
    //                url: "https://api.pioneerfoods.in/Quality_Template/Create_Template_SkillMatrix",
    //                type: "POST",
    //                data: postdata,
    //                async: false,
    //                dataType: "json",
    ...
    function execution(template_ID) {
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_Template_Execution",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    function Createauditschedule(template_ID) {
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_Template_AuditSchedule",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    function CreateAuditordetails(template_ID) {
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_Template_Auditordetails",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    function CreateAuditorMeetingdetails(template_ID) {
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_Template_AuditorMeeting",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    function CreateAuditChecklist(template_ID) {
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_Template_AuditChecklist",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    function CreateNCandCAtable(template_ID) {
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_Template_NCC",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
               ...
               /* postdata.append('TypeofAudit', auditType);*/
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_Template_MRM",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    function CreateAuditorRecommendation(template_ID) {
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_Template_AuditorRecommendation",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    function CreateQualityStatus(template_ID) {
        ...
        if (gettablelength > 0) {
            for (var i = 0; i < gettablelength; i++) {
                ...
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Create_Template_Certification",
                    type: "POST",
                    data: postdata,
                    async: false,
                    dataType: "json",
    ...
    $("#table-iddoc").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_QualityStandard?Adminid=" + ADMIN_AUTH + "&id=" + id + "",
                    type: "POST",
                    contentType: false, // Not to set any content header
                    processData: false, // Not to process data
                    /*data: fileData,*/
    ...
    $("#table-quality").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_QualityTemplate_Document?AdminID=" + ADMIN_AUTH + "&ID=" + id + "",
                    type: "POST",
                    contentType: false, // Not to set any content header
                    processData: false, // Not to process data
                    /*data: fileData,*/
    ...
    //        if (result) {
    //            $.ajax({
    //                url: "https://api.pioneerfoods.in/Quality_Template/Delete_QualityTemplate_Annual?AdminID=" + ADMIN_AUTH + "&Id=" + id + "",
    //type: POST,
    //contentType: false, // Not to set any content header
    //                processData: false, // Not to process data
    //                /*data: fileData,*/
    ...
    //        if (result) {
    //            $.ajax({
    //                url: "https://api.pioneerfoods.in/Quality_Template/Delete_QualityTemplate_Monthly?AdminID=" + ADMIN_AUTH + "&ID=" + id + "",
    //                type: "POST",
    //                contentType: false, // Not to set any content header
    //                processData: false, // Not to process data
    //                /*data: fileData,*/
    ...
    //        if (result) {
    //            $.ajax({
    //                url: "https://api.pioneerfoods.in/Quality_Template/Delete_Template_SkillMatrix?AdminID=" + ADMIN_AUTH + "&Id=" + id + "",
    //                type: "POST",
    //                contentType: false, // Not to set any content header
    //                processData: false, // Not to process data
    //                /*data: fileData,*/
    ...
    $("#execution").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_Template_Execution?AdminID=" + ADMIN_AUTH + "&ID=" + id + "",
                    type: "POST",
                    contentType: false, // Not to set any content header
                    processData: false, // Not to process data
                    /*data: fileData,*/
    ...
    $("#audit").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_Template_AuditSchedule?AdminID=" + ADMIN_AUTH + "&ID=" + id + "",
                    type: "POST",
                    contentType: false, // Not to set any content header
                    processData: false, // Not to process data
                    /*data: fileData,*/
    ...
    $("#auditor").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_Template_Auditordetails",
                    type: "POST",
                    data: postdata,
                    contentType: false, // Not to set any content header
                    processData: false, // Not to process data
    ...
    $("#auditmeet").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_Template_AuditorMeeting",
                    type: "POST",
    ...
    $("#standardTemplate").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_Template_AuditChecklist",
                    type: "POST",
                    data: { "authorid": ADMIN_AUTH, "ID": id },
                    contentType: false, // Not to set any content header
                    processData: false, // Not to process data
    ...
    $("#nc-caDetails").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_Template_NCC?AdminId",
                    type: "POST",
                    data: { "authorid": ADMIN_AUTH, "ID": id },
                    contentType: false, // Not to set any content header
                    processData: false, // Not to process data
    ...
    $("#managementReviewMeeting").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_Template_MRM",
                    type: "POST",
                    data: postdata,
                    contentType: false, // Not to set any content header
                    processData: false, // Not to process data
    ...
    $("#auditrec").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_Template_AuditorRecommendation",
                    type: "POST",
                    data: { "authorid": ADMIN_AUTH, "ID": id },
                    contentType: false, // Not to set any content header
                    processData: false, // Not to process data
    ...
    $("#qualityStatus").on("click", ".deleteRow", function () {
        ...
        if (id != undefined) {
            ...
            if (result) {
                $.ajax({
                    url: "https://api.pioneerfoods.in/Quality_Template/Delete_Template_Certification",
                    type: "POST",
                    data: { "authorid": ADMIN_AUTH, "ID": id },
                    contentType: false, // Not to set any content header
                    processData: false, // Not to process data
