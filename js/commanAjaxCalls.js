...
const UPDATE_PO_BILL_URL = APIS.updatePOBill;
...
const createBillForPo = (PRICING_id, URL) => {
    ...
    $.ajax({
        url: URL,
        type: "POST",
        data: { ...billData, "AdminId": ADMIN_AUTH, "PurchaseorderID": templateId, "balance": Number(dueAmount), "paid": Number(paidAmount) },
        async: false,
        dataType: "JSON",
        crossDomain: true,
        success: (data) => {
...
const updateBillForInvoice = (PRICING_id, URL) => {
    ...
    $.ajax({
        url: URL,
        type: "POST",
        data: { ...billData, "AdminId": ADMIN_AUTH, "TemplateId": templateId, "id": billId, "balance": Number(dueAmount), "paid": Number(paidAmount) },
        async: false,
        dataType: "JSON",
        crossDomain: true,
        success: (data) => {
...
const updateBillForPo = (PRICING_id, URL) => {
    ...
    $.ajax({
        ...
        type: "POST",
        async: false,
        data: { ...billData, "ID": PRICING_id, "AdminId": ADMIN_AUTH, "TemplateId": templateId, "ID": billId, "balance": Number(dueAmount), "paid": Number(paidAmount) },
        dataType: "JSON",
        crossDomain: true,
        success: (data) => {
            if (data.responsecode === 1) {
...
class commonAjaxCalls {
        ...
        $.ajax({
            ...
            success: (data) => {
                if (data.responsecode == 1) {
                    ...
                    // calling bill create method
                    updateBillForPo(PRICING_id, UPDATE_PO_BILL_URL);
                } else {
                    ERROR_MESSAGE(data.responsemessage);
                }
            }
    ...
    priceAndBillUpdationAtOnceForPo = (data, URL) => {
        debugger;
        $.ajax({
            url: URL,
            type: "POST",
