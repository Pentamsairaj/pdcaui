...
const getServiceFormData = () => {
    ...
    const templateData = {
        ...
        "emailid": companyEmail,
        "phone": companyPhone,
        "ContactPersonName": cont_name,
        "ContactPersonNumber": cont_Phone,
        "GSTNumber": companyGstNumber,
        "Refferedby": referredBy,
        "templatename": titleOfTemplate,
        "team_membername": teamMemberName,
...
const getPoCommonFormData = () => {
    ...
    const templateData = {
        ...
        "Team_emailid": teamEmail,
        "Team_phone": teamPhone,
        "Teamcompany": teamCompanyName,
        "Team_Address": teamAddress,
        "Team_GSTNo": teamGstNumber,
        "fromBank_Account": teamBankAcNo,
        "fromBankName": teamBankName,
        "fromBank_IFSC_Code": teamIfscCode,
        "tandc": termsAndConditions,
        "isscopeofwork": isScopeOfWork,
        "scopeofwork": scopeOfWorkDescription,
...
const getBillData = () => {
    ...
    const billData = {
        ...
        "cgst": Number(cgst),
        "igst": Number(igst),
        "grandTotal": Math.round(Number(grandToatl)),
