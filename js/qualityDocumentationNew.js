        ...
        if (value) {
            ...
            if (value.multidoc != null) {
                ...
                multidocUrls.forEach(function (url, i) {
                    multidocViewButtons += `<a href="${url.trim()}" target="_blank" class="btn btn-primary btn-sm my-1">View</a><br>`;
                });
            }
